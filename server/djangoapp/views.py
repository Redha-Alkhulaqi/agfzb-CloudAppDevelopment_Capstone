...
def get_dealer_details(request, dealer_Id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://us-south.functions.appdomain.cloud/api/v1/web/reda.ali.ahmed%40gmail.com_djangoserver-space/dealership-package/get-dealership"
        dealer = get_dealer_from_cf_by_id(dealer_url,  dealerId=dealerId)
        context["dealer"] = dealer
        
        review_url = "https://us-south.functions.appdomain.cloud/api/v1/web/reda.ali.ahmed%40gmail.com_djangoserver-space/dealership-package/get-review"
